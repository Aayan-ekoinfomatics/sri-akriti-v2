          ...
          {product_details?.product?.map((data, i) => (
            <div key={i} className='relative'>
              ...
              <div className="w-full md:w-[80%] flex justify-between sticky botton-0 right-0 text-black my-5">
                <Link to='/cart'><button className="bg-black text-white p-2 px-2 md:p-4 md:px-14 poppins text-[15px] md:text-[22px] tracking-[2px] md:tracking-[3px]">ADD TO CART</button></Link>
              ...
              <div className="w-full poppins text-[12px] md:text-[14px] my-4">
