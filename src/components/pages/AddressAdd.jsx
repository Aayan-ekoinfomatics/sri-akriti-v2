  ...
  return (
    <div className='w-full pb-10 border-2 bg-[#eeeeee]'>
        <div className='w-full mt-5'>
            <p className='poppins tracking-[2px] text-[10px]'>Home / Accounts</p>
        </div>
        <div className='w-full text-center my-10'>
            <h1 className='lora italic font-[500] text-[20px]'>Add New Address</h1>
        </div>
        <div className='w-[90%] md:w-[40%] mx-auto flex flex-col gap-3 justify-center items-center'>
            ...
            <div className='w-full flex justify-between md:justify-center md:gap-20 pt-5 md:pt-10'>
                <button className='p-2 px-8 md:p-4 md:px-14 poppins tracking-[3px] lora text-[11px] md:text-[13px] bg-white text-black' >CANCEL</button>
                <button className='p-2 px-8 md:p-4 md:px-14 poppins tracking-[3px] lora text-[11px] md:text-[13px] bg-black text-white' >SAVE</button>
            </div>
        </div>
    </div>
  )
