...
const Cart = () => {
  return (
    ...
    <div className="w-full pb-24">
      ...
      
      {
        ...
        <div className="border-t border-t-black md:border-t-0 md:border-l md:border-l-black w-[90%] md:w-full mx-auto md:px-3 md:pl-10 md:max-w-[500px] max-w-[400px]">
          ...
          <div className="w-full poppins flex justify-between items-center py-3 text-[#696969c7]">
              ...
              <h1 className="text-[13px] md:text-[16px] font-[400]">₹ {card_data?.checkout_data?.sub_total?.amount}</h1>
          </div>
          <div className="w-full poppins flex justify-between items-center py-3 text-[#696969c7]">
          ...
          <div className="w-full poppins flex justify-between items-center py-3 text-[#696969c7]">
              ...
              <h1 className="text-[13px] md:text-[16px] font-[400]">{card_data?.checkout_data?.tax?.amount}</h1>
          </div>
          <div className="w-full poppins flex justify-between items-center py-3">
      ...
      <div className="w-[90%] md:w-[80%] mx-auto grid gap-2 md:gap-3 grid-cols-2 md:grid-cols-3 pt-12">
            {card_data?.products?.map((data, i) => (
              <div className="relative p-2 w-full" key={i}>
                ...
                <div className="">
                  ...
                  <button className="bg-[#3EDCFF] w-full p-2 md:p-3 text-[12px] py-1 md:text-[16px] md:font-[500] text-white tracking-[1px] md:tracking-[3px]">
                    ADD TO CART
                  </button>
                  <p className="font-[500] poppins text-[12px] md:text-[16px] py-1 tracking-[2px] pl-1">
                    ₹{data?.price}
                  </p>
                  <p className="font-[300] poppins text-[11px] md:text-[16px] py-1 tracking-[1.4px] pl-1">
                    {data?.title}
                  </p>
                </div>
              </div>
