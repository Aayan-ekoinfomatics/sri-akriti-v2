  ...
  return (
    <div className='w-full bg-[#ffffff] pb-10'>
        ...
        <form onSubmit={(e) => e.preventDefault()} className='w-[85%] max-w-[600px] mx-auto mb-10'>
            <div className='flex justify-between md:px-10'>
                <div className='flex items-center'>
                    <input type="radio" className='pr-7 bg-[#e3e3e3]' name="Male" id="" />
                    <label htmlFor="input" className='pl-5 poppins text-[14px] tracking-[2px]'>Male</label>
                </div>
                <div className='flex items-center'>
                    <input type="radio" className='pr-7 bg-[#e3e3e3]' name="Female" id="" />
            ...
            <div className='py-2 w-full flex flex-col relative'>
                <input type="text" placeholder='Name' className='my-2 poppins tracking-[2px] text-[13px] md:text-[15px] px-3 py-2 md:p-4 font-[300] bg-[#e3e3e3]' name="name" id="" />
                <input type="text" placeholder='Email ID' className='my-2 poppins tracking-[2px] text-[13px] md:text-[15px] px-3 py-2 md:p-4 font-[300] bg-[#e3e3e3]' name="name" id="" />
        ...
        <div className='w-full flex justify-center items-center my-4 tracking-[2px] lora font-[400]'>
            <h1>Already a user ? <Link to='/account' className='underline'>Login</Link></h1>
        </div>
        </form> 
    </div>
  )
